    ...
    <nav class="navbar">
        <div class="col-12">
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="{{ route('admin.dashboard') }}" class="inbox-btn hidden-sm-down" data-close="true"><i
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown"><a href="javascript:void(0);" class="dropdown-toggle xs-hide"
