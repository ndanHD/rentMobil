...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('editMobil', ['id' => $car->id]) }}" method="post">
                @csrf

                <div class="form-group">
                    <label for="brand">Merk Mobil</label>
                    <input type="text" value="{{ $car }}" name="brand" id="brand" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="23" name="model" id="model" class="form-control" required
